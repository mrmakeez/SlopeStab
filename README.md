...
2. `python -m slope_stab.cli verify` (built-in verification covers Case 1-4, DIRECT global benchmarks for Cases 2-4, and Cuckoo global benchmarks for Cases 2-4)
