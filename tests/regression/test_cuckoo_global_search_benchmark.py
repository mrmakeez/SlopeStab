...
BENCHMARK_FOS = {
    "case2_cuckoo_global.json": 2.11283,
...
def _assert_valid_result(testcase: unittest.TestCase, result) -> None:
    ...
    testcase.assertEqual(search_meta.get("method"), "cuckoo_global_circular")
    testcase.assertIn("cuckoo_global_circular", search_meta)
