...
BENCHMARK_FOS = {
    ...
    "case2_direct_global.json": 2.10296,
    "case3_direct_global.json": 0.986442,
    "case4_direct_global.json": 1.234670,
}
MARGIN = 0.01


class GlobalSearchBenchmarkRegressionTests(unittest.TestCase):
    def test_case2_case3_case4_within_benchmark_margin_and_repeatable(self) -> None:
        ...
        for fixture_name, benchmark in BENCHMARK_FOS.items():
            with self.subTest(fixture=fixture_name):
                ...
                assert_global_search_result_shape(self, result1, "direct_global_circular", "direct_global_circular")
                assert_global_search_result_shape(self, result2, "direct_global_circular", "direct_global_circular")
