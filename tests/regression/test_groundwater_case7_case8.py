...
_SCENARIOS: tuple[_Scenario, ...] = (
    _Scenario(
        ...
        fos_tolerance=0.005,
        series_column=0,
        production_weight_tol=0.25,
        production_pore_tol=0.6,
        production_normal_tol=0.6,
        boundary_tol=0.02,
    ...
    _Scenario(
        ...
        fos_tolerance=0.02,
        series_column=1,
        production_weight_tol=0.4,
        production_pore_tol=1.0,
        production_normal_tol=1.2,
        boundary_tol=0.05,
        exact_weight_tol=0.002,
        exact_pore_tol=0.001,
        exact_normal_tol=0.01,
    ...
    _Scenario(
        ...
        fos_tolerance=0.005,
        series_column=0,
        production_weight_tol=1.1,
        production_pore_tol=1.4,
        production_normal_tol=1.0,
        boundary_tol=0.1,
        exact_weight_tol=0.002,
        exact_pore_tol=0.001,
        exact_normal_tol=0.01,
